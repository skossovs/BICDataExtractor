...
{
    public class YahooIncomeStatementMerger : FileReader<IncomeStatementData>, IFileMerger<IncomeStatementData>
    {
        private ILog _logger = LogServiceProvider.Logger;
        public YahooIncomeStatementMerger(string fileName)
        {
            _fileName = fileName;
        }
        public void Merge(IEnumerable<IncomeStatementData> newData)
        {
